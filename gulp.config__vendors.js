module.exports = function (smarty) {
    ...
    return {
        ...
        list: {
            ...
            markdowneditor: {enable: false, autoinit: true, bundle: false}, 		// 105Kb
            ...
            select2: {enable: true, autoinit: true, bundle: false}
        ...
        */
        ...
        sortable: {				/* SORTABLE [SOW File Upload - need it] */
            path_js: ['node_modules/sortablejs/dist/sortable.umd.js'], 								// 42Kb
            path_css: [],
        ...
        select2: {				/* SELECT2 */
            path_js: [
                /*'node_modules/select2/src/js/jquery.mousewheel.shim.js',
                'node_modules/select2/src/js/jquery.shim.js',
                'node_modules/select2/src/js/jquery.select2.js',
                'node_modules/select2/src/js/banner.end.js',
                'node_modules/select2/src/js/banner.start.js',
                'node_modules/select2/src/js/wrapper.end.js',
                'node_modules/select2/src/js/wrapper.start.js',
                'node_modules/select2/src/js/select2/core.js',
                'node_modules/select2/src/js/select2/defaults.js',
                'node_modules/select2/src/js/select2/utils.js',
                'node_modules/select2/src/js/select2/diacritics.js',
                'node_modules/select2/src/js/select2/dropdown.js',
                'node_modules/select2/src/js/select2/keys.js',
                'node_modules/select2/src/js/select2/options.js',
                'node_modules/select2/src/js/select2/results.js',
                'node_modules/select2/src/js/select2/translation.js',
                'node_modules/select2/src/js/select2/compat/containerCss.js',
                'node_modules/select2/src/js/select2/compat/dropdownCss.js',
                'node_modules/select2/src/js/select2/compat/initSelection.js',
                'node_modules/select2/src/js/select2/compat/inputData.js',
                'node_modules/select2/src/js/select2/compat/matcher.js',
                'node_modules/select2/src/js/select2/compat/query.js',
                'node_modules/select2/src/js/select2/compat/utils.js',
                'node_modules/select2/src/js/select2/data/ajax.js',
                'node_modules/select2/src/js/select2/data/array.js',
                'node_modules/select2/src/js/select2/data/base.js',
                'node_modules/select2/src/js/select2/data/maximumInputLength.js',
                'node_modules/select2/src/js/select2/data/maximumSelectionLength.js',
                'node_modules/select2/src/js/select2/data/minimumInputLength.js',
                'node_modules/select2/src/js/select2/data/select.js',
                'node_modules/select2/src/js/select2/data/tags.js',
                'node_modules/select2/src/js/select2/data/tokenizer.js',
                'node_modules/select2/src/js/select2/dropdown/attachBody.js',
                'node_modules/select2/src/js/select2/dropdown/attachContainer.js',
                'node_modules/select2/src/js/select2/dropdown/closeOnSelect.js',
                'node_modules/select2/src/js/select2/dropdown/hidePlaceholder.js',
                'node_modules/select2/src/js/select2/dropdown/infiniteScroll.js',
                'node_modules/select2/src/js/select2/dropdown/minimumResultsForSearch.js',
                'node_modules/select2/src/js/select2/dropdown/search.js',
                'node_modules/select2/src/js/select2/dropdown/selectOnClose.js',
                'node_modules/select2/src/js/select2/dropdown/stopPropagation.js',
                'node_modules/select2/src/js/select2/i18n/it.js',
                'node_modules/select2/src/js/select2/i18n/en.js',
                'node_modules/select2/src/js/select2/selection/allowClear.js',
                'node_modules/select2/src/js/select2/selection/base.js',
                'node_modules/select2/src/js/select2/selection/clickMask.js',
                'node_modules/select2/src/js/select2/selection/eventRelay.js',
                'node_modules/select2/src/js/select2/selection/multiple.js',
                'node_modules/select2/src/js/select2/selection/placeholder.js',
                'node_modules/select2/src/js/select2/selection/search.js',
                'node_modules/select2/src/js/select2/selection/single.js',
                'node_modules/select2/src/js/select2/selection/stopPropagation.js'*/
            ...
            path_css: [
                ...
                'src/scss/_vendors/vendor.select2.scss'
            ],
            controller: 'src/js/vendors/vendor.select2.js',
